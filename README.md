...
> 
> Installing uv also requires you to add the tools to your systems PATH, otherwise you can not use uv to run the commands like `uv python install`. Try opening a new VSCode terminal after installation and see if it fixes the error, otherwise run the command:
> ```powershell
